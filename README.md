...
flowchart TD
    ...
    CheckLectureMode -->|❌ NON - LECTURE false| NoAPIMode[📝 MODE LEGACY<br/>Pas d appel API<br/>donnees_scenario_api vide]
    ...
    %% ========== CAS PLANNING VIOLÉ ==========
    PlanningResult -->|❌ JOUR FÉRIÉ| PlanningHoliday[🎄 Jour férié interdit<br/>flag_ferie différent de true]
